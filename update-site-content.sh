...
do
    ...
    sed -i "/fingerprint-expires/c$EXPIRES" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-sha1/c$SHA1" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-sha256/c$SHA256" /root/xmpp-site/config/config-$DOMAIN.yml
    ...
    sed -i "/fingerprint-im-expires/c$IMEXPIRES" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-im-sha1/c$SHA1IM" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-im-sha256/c$SHA256IM" /root/xmpp-site/config/config-$DOMAIN.yml
    ...
    sed -i "/fingerprint-conference-expires/c$CONFERENCEEXPIRES" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-conference-sha1/c$SHA1CONFERENCE" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-conference-sha256/c$SHA256CONFERENCE" /root/xmpp-site/config/config-$DOMAIN.yml
    ...
    sed -i "/fingerprint-proxy-expires/c$PROXYEXPIRES" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-proxy-sha1/c$SHA1PROXY" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-proxy-sha256/c$SHA256PROXY" /root/xmpp-site/config/config-$DOMAIN.yml
    ...
    sed -i "/fingerprint-upload-expires/c$UPLOADEXPIRES" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-upload-sha1/c$SHA1UPLOAD" /root/xmpp-site/config/config-$DOMAIN.yml
    sed -i "/fingerprint-upload-sha256/c$SHA256UPLOAD" /root/xmpp-site/config/config-$DOMAIN.yml
done
